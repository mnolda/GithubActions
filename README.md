[![Run App Mercedes Nolda](https://github.com/mnolda/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/mnolda/GithubActions/actions/workflows/run-app.yaml)
